...
class ConnectorTest {
    ...
    void connect() throws SQLException {
        ...
        assertEquals(SOME_USER, actualProperties.getProperty(Connector.USER_PROPERTY));
        assertEquals(SOME_PASSWORD, actualProperties.getProperty(Connector.PASSWORD_PROPERTY));
    }
